          ...
          <div className="row g-5">
            <div className="col-md-6 col-lg-4">
              <div className="bg-primary rounded p-4">
                <Link to="/">
                  <h1 className="text-white text-uppercase mb-3">Hotelux</h1>
                </Link>
                <p className="text-white mb-0">
                We invite you to discover the essence of hospitality at Hoteluxe, 
                where every moment is crafted with care and every stay is an experience
                 to remember.
                </p>
              </div>
            </div>
